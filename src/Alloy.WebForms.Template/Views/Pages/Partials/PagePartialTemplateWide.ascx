<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="PagePartialTemplateWide.ascx.cs" Inherits="AlloyTemplates.Views.Pages.Partials.PagePartialTemplateWide" %>
