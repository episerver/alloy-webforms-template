<%@ Page Language="C#" MasterPageFile="~/Views/MasterPages/TwoPlusOne.master" Codebehind="SearchPageTemplate.aspx.cs" Inherits="AlloyTemplates.Views.Pages.SearchPageTemplate" %>
    ...
    <div class="row">
        <div class="span8">
            <asp:Panel DefaultButton="SearchButton" runat="server">
                ...
                <asp:Button Text='<%# Translate("/searchpagetemplate/searchbutton") %>' Enabled="<%# SearchSettings.Options.Active %>" CssClass="btn" TabIndex="2" OnClick="SearchClick" ID="SearchButton" runat="server" />
            </asp:Panel>
